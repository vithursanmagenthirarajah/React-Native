...
export default function Screen4(props) {
    const details = props.route.params.item.data;
let arr2=[]
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            <View style={{ paddingHorizontal: 30,flex:1,flexDirection:"column"}}>
                ...
                <Text style={{fontSize:35, fontWeight:"bold",marginTop:20}}>Emission Limit</Text>
                </View>
...
{}
                        ...
                        <View style={{ padding:10, borderColor:"#c4c4c4",marginBottom:20, minWidth:"100%",flex:1,flexDirection:"column",alignItems:'center'}}>
                            <View style={{flex:1,flexDirection:'row',alignItems:'center'}}>
                                ...
                                <View style={{flex:2}}>
                                    <Text style={{fontSize:22, color:'#626262',alignItems:'center' }}> {item[1]} Kg CO2</Text>
                                </View>
                            </View>
